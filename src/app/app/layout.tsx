      ...
      >
        ...
        <nav className="mt-8 flex flex-col gap-1 text-sm">
          ...
          {hasPermission(session.role, "costs:view") && (
            <Link className="rounded-2xl px-4 py-3 hover:bg-black/4" href="/app/finance">
              الماليات
            </Link>
          )}
          ...
          {hasPermission(session.role, "payments:view") && (
            <Link className="rounded-2xl px-4 py-3 hover:bg-black/4" href="/app/finance/payments">
              المدفوعات
            </Link>
          )}
          {hasPermission(session.role, "invoices:view") && (
            <Link className="rounded-2xl px-4 py-3 hover:bg-black/4" href="/app/finance/aging">
              تقرير الأعمار
            </Link>
          )}
          ...
          {hasPermission(session.role, "projects:manage") && (
            <Link className="rounded-2xl px-4 py-3 hover:bg-black/4" href="/app/settings/stages">
              إعدادات المراحل
            </Link>
          )}
