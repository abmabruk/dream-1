      ...
      <div className="gc-form-dialog" onClick={(e) => e.stopPropagation()}>
        ...
        <form onSubmit={handleSubmit} className="gc-form">
            ...
            <div className="gc-form-priority-row">
              {PRIORITIES.map((p) => (
                <button
                  key={p}
                  type="button"
                  className={`gc-form-priority-btn ${priority === p ? "gc-form-priority-active" : ""}`}
          ...
          <div className="gc-form-actions">
            <button type="button" className="gc-form-cancel-btn" onClick={onClose}>إلغاء</button>
            <button type="submit" className="gc-form-submit-btn" disabled={saving}>
